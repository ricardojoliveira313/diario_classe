...
function construirDraft(l:Linha,r:PrepareResponse,base:EducacensoLookup|null):{draft:Draft;avisoIdade:string}{
  ...
  const endereco=splitEndereco(first(f.endereco,p.endereco));const superioresBrutos=montarSuperiores(r);
  ...
  const draft:Draft={
    ...
    modalidade:l.modalidade||modalidadeSugerida(l.servidor,l.frequencia,l.turmas),cpf:dig(official.cpf||f.cpf||p.cpf),
    dataNasc,sexo:sexoEdu,
