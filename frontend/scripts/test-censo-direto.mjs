...
const checks = [
  ...
  ['modalidade sugerida preenche o rascunho e continua editável', page.includes('modalidade:l.modalidade||modalidadeSugerida') && page.includes('Sugestão automática:') && page.includes('onChange={v=>patch(\'modalidade\',v)}')],
