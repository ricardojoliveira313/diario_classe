...
const checks = [
  ...
  ['instituição oficial pode ser buscada pelo nome', page.includes('SearchableSelectField') && page.includes('Buscar pelo nome da instituição') && page.includes('norm(opcao).includes(termo)')],
  ...
  ['sexo vem da planilha mestre quando ela existe', page.includes("sexo:temMestre?inOptions(m.Sexo,SEXOS):sexoEdu")],
  ...
  ['pós da planilha é aplicada sem descarte cronológico', page.includes('posMestre(m)') && page.includes('temMestre?{pos:posCheckIdade.itens,descartados:0}')],
